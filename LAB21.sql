...
SELECT P.RazonSocial, SUM(entregan.cantidad * materiales.precio * (1 + materiales.impuesto / 100)) AS Importetotal, COUNT(*) AS NumEntregas
FROM proveedores P
INNER JOIN entregan ON P.rfc = entregan.rfc
